                        ...
                        <div class="game-card rounded-xl p-6">
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="inter text-blue-100 mb-3">Mình vừa làm video hướng dẫn chi tiết cách chơi bài này, các bạn xem và góp ý nhé!</p>
                                    <div class="flex items-center space-x-6 mb-2">
                                        <span class="flex items-center gap-1 text-pink-400 font-semibold"><span>❤️</span><span>12</span></span>
                                        <span class="flex items-center gap-1 text-blue-300 font-semibold"><span>💬</span><span>3</span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="game-card rounded-xl p-6">
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="inter text-blue-100 mb-3">Chúng mình vừa cập nhật 3 bài nhạc mới từ season mới nhất, mọi người check shop nhé!</p>
                                    <div class="flex items-center space-x-6 mb-2">
                                        <span class="flex items-center gap-1 text-pink-400 font-semibold"><span>❤️</span><span>8</span></span>
                                        <span class="flex items-center gap-1 text-blue-300 font-semibold"><span>💬</span><span>1</span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
