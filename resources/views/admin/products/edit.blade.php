...
<div id="products-edit" class="admin-content active px-6 pb-6">
    <div class="admin-card rounded-xl p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.products.index') }}" class="bg-gray-500 hover:bg-gray-600 px-6 py-3 rounded-lg text-white inter font-semibold">
                ← Quay Lại
            </a>
        </div>
        ...
        <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white bg-opacity-5 rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-blue-200 mb-4">
                    <div>
                        <strong>File hiện tại:</strong> {{ basename($product->file_path) }}
                    </div>
                    <div>
                        <strong>Tạo lúc:</strong> {{ $product->created_at->format('d/m/Y H:i') }}
                    </div>
                    <div>
                        <strong>Cập nhật lần cuối:</strong> {{ $product->updated_at->format('d/m/Y H:i') }}
                    </div>
                    <div>
                        <strong>Lượt tải:</strong> {{ $product->downloads_count }}
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative" x-data="{ 
                            open: false, 
                            selected: getCountryWithFlag('{{ old('country_region', $product->country_region) }}'), 
            ...
            <div class="flex justify-center space-x-4">
                <a href="{{ route('admin.products.index') }}" class="bg-gray-500 hover:bg-gray-600 px-8 py-3 rounded-lg text-white inter font-semibold text-lg">
                    ← Hủy bỏ
                </a>
