        ...
        <div class="admin-sidebar w-64 p-6 flex flex-col">
            ...
            <nav class="flex-1">
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('admin.settings') }}" class="sidebar-link w-full text-left px-4 py-3 rounded-lg text-white inter flex items-center space-x-3">ℹ️ Thông Tin</a></li>
